...
const usersAndPins = document.querySelector('.users_and_pins');
usersAndPins.style.display = 'none';
document.querySelector('.accs').onmouseout = () => usersAndPins.style.display = 'none';
document.querySelector('.accs').onmouseover = () => usersAndPins.style.display = 'block';
